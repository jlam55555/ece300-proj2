...
[true_sym_ap, est_sym_ap] = simulate_transmission(bin_ap_const, bin_ap_m, N0, SNR);
errors_ap = num_errors(true_sym_ap, est_sym_ap);
...
%%
bi_ortho_cons = [1;1j];
rand11 = round(rand(N,1)+1);
bi_ortho_m = bi_ortho_cons(round(rand11));
